...
public enum Planeta {
    ...
    double surfaceWeight(double othermasa) {
        return othermasa * surfaceGravity();
    }
    ...
    public static void main(String[] args) {
        ...
        double masa = earthWeight/EARTH.surfaceGravity();
        for (Planeta p : Planeta.values())
            System.out.printf("Your weight on %s is %f%n",
                    p, p.surfaceWeight(masa));
    }
}